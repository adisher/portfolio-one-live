...
// Injected on the public page only (never the admin panel). Each block renders
// only when its ID is configured. The visitor's own GA/Meta/TikTok account does
// the collection — no server-side infrastructure on our side.
export function TrackingScripts({ ga, meta, tiktok }: TrackingScriptsProps) {
  return (
    <>
      {ga && (
        <>
